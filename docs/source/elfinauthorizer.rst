...
.. code-block::
   ...
   /eh_log?contract=<contract-address>&block=<blockhash>&topic1=<hex-string>&topic2=<hex-string>&topic3=<hex-string>&topic4=<hex-string>
...
.. code-block::
  ...
  To Authorizer: time=<unix-timestamp>, contract=<contract-evm-address>, datalisthash=<keccak256-of-datalist-with-0x-prefix>
